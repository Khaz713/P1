...
/**
 * This class was created to allow user change sound and music options
...
public class Options {
    ...
    /**
     *The background image of the menu and icons for sound and music
     */
    private Image menuOne, sound, music;
    ...
    /**
     * This method updates the Options class.
     ...
     * It also draw the title of the Options class, background and two guns besides the selected button.
