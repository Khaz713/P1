...
/**
 * Class created to allow user to choose after finishing the level
 * if he wants to continue or stop playing the game
...
public class CongratsScreen {
    ...
    /**
     * An array of several Buttons for CongratsScreen class
     * @see Button
     */
    ...
    /**
     * This method updates the CongratsScreen class.
     ...
     * It also draw the title of the CongratsScreen class, background and two guns besides the selected button.
